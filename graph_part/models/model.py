...
class DySAT(nn.Module):
    def __init__(self, args, num_features, time_length):
        ...
        # print(self.num_features) #节点数量 143
        # print(self.structural_head_config) #[16, 8, 8]
        # print(self.structural_layer_config) #[128]
        # print(self.temporal_head_config) #[16]
        # print(self.temporal_layer_config) #[128]
        # print("i'm here!")
    ...
    def forward(self, graphs):
        ...
        structural_outputs = [g.x[:,None,:] for g in structural_out] # list of [Ni, 1, F] Ni是当前时刻节点的数量 [18,1,128],[23,1,128]...
        ...
        structural_outputs_padded = torch.cat(structural_outputs_padded, dim=1) # [N, T, F] [143,16,128]
  
        # print(structural_outputs_padded.shape)
        #print('break 3')
